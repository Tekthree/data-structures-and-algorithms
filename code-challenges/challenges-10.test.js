...
const createServer = () => {
  ...
  app.get('/aboutme', boutMeHandler);
  app.get('/favoritefoods', favFoodHandler)
  app.get('/*', errorHandler);


  //function handlers for routes
  function favFoodHandler(req,res){
    res.send(['pizza', 'burger', 'tator tots']);
  }

  function boutMeHandler(req,res){
    res.send('This is the story of a girl Who cried a river and drowned the whole world And while she looked so sad in photographs I absolutely love her, when she smiles');
  }
